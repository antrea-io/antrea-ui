...
server {
    ...
    location / {
        ...
        # Frontend plugins are dropped into /etc/plugins at runtime (not baked into the image);
        # /etc/plugins/index.json is generated by the plugin-index-builder startup script.
        location /plugins/ {
            alias /etc/plugins/;
        }
