...
| https | object | `{"auto":{"commonName":"localhost","daysValid":365,"dnsNames":[],"ipAddresses":[]},"enable":false,"method":"auto","secret":{"secretName":"antrea-ui-tls"},"user":{"cert":"","key":""},"userCA":{"cert":"","commonName":"localhost","daysValid":365,"dnsNames":[],"ipAddresses":[],"key":""}}` | HTTPS configuration for the Antrea UI. |
