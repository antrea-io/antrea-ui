...
// GetPluginFile serves one file from a plugin's bundle.zip (or its manifest.json, served
// separately, see pkg/plugins), so the frontend can import() it at runtime.
